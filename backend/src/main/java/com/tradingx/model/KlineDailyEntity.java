...
@Table(name = "kline_daily", indexes = {
    @Index(name = "idx_kline_daily_ts_date", columnList = "ts_code, trade_date", unique = true),
    @Index(name = "idx_kline_daily_date", columnList = "trade_date")
}, comment = "日K线表 - 存储股票日线级别的K线数据")
public class KlineDailyEntity {
