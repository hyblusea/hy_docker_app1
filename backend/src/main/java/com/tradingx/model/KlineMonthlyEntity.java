 ...
 */
@Entity
@Table(name = "kline_monthly", indexes = {
    @Index(name = "idx_kline_monthly_ts_date", columnList = "ts_code, trade_date", unique = true),
    @Index(name = "idx_kline_monthly_date", columnList = "trade_date")
}, comment = "月K线表 - 存储股票月线级别的K线数据")
public class KlineMonthlyEntity {
