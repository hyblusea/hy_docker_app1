...
public class StrategyAnalysisProgress {
    ...
    @JsonProperty("strategy_completed")
    public int getStrategyCompleted() { return strategyCompleted; }
    public void setStrategyCompleted(int strategyCompleted) { this.strategyCompleted = strategyCompleted; }
