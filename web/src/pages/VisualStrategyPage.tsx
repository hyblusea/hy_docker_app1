...
const VisualStrategyPage = ({ onStrategyChanged }: VisualStrategyPageProps) => {
  ...
  }, [strategyName, strategyId, config, message, invalidateStrategies, onStrategyChanged])
  ...
  }, [strategyName, strategyId, javaCodeView, message, invalidateStrategies, onStrategyChanged])
  ...
  }, [newName, message, invalidateStrategies, handleLoad, onStrategyChanged])
  ...
  }, [aiStrategyName, aiCode, aiBuyDesc, aiSellDesc, message, invalidateStrategies, handleLoad, onStrategyChanged])
  ...
  }, [codeImportName, codeImportCode, codeImportResult, message, invalidateStrategies, onStrategyChanged])
  ...
  }, [strategyList, strategyId, message, invalidateStrategies, onStrategyChanged])
  ...
  }, [strategyId, message, modal, handleNew, invalidateStrategies, onStrategyChanged])
      ...
      <div className={styles.mainArea}>
        ...
        <div className={styles.body}>
          ...
          <div className={styles.builder}>
            <div
              className={`${styles.section} ${styles.indicatorSection} ${dragOverTarget === 'indicators' ? styles.sectionDragOver : ''}`}
              onDragOver={(e) => {
